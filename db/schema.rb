...
ActiveRecord::Schema.define(version: 2022_03_16_211658) do
  ...
  create_table "movie_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["categories_id"], name: "index_movie_categories_on_categories_id"
    t.index ["movies_id"], name: "index_movie_categories_on_movies_id"
  end
  ...
  add_foreign_key "movie_categories", "movies", column: "movies_id"
end
